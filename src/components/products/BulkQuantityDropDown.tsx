...
const BulkQuantityDropDown: React.FC<DropDownProps> = ({
  label,
  options,
  onChange,
  value,
  ...
  return (
    <>
      <MediaQuery minWidth={769}>
        <Box width="100%" className="flexbox2" mb="0.75rem">
          <Typography color="#8D8A8A" mb={"6px"}>
            {label}
          </Typography>
          <StyledDropDown
...
export default BulkQuantityDropDown;
